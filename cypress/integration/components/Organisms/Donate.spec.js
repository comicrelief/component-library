    ...
    describe('Donate Form align right section', () => {
        ...
        it('renders donate form align right preview', () => {
            ...
            cy.get('@container')
                ...
                .clear()
                .type(' ')
                .should('have','Please enter an amount between £1 and £20,000, and up to 2 decimal places')
                .clear()
                .type('15.999');
            cy.get('@container')
                .find('p')
    ...
    describe('Single Giving "No Money Buys" section', () => {
        ...
        it('renders Single Giving "No Money Buys" preview', () => {
            ...
            cy.get('@container')
                ...
                .clear()
                .type('5')
                .should('not.have','Please enter an amount between £1 and £20,000, and up to 2 decimal places');
            cy.get('@container')
                .find('p')
                .should('have','Please enter an amount between £1 and £20,000, and up to 2 decimal places');
            cy.get('@container')
