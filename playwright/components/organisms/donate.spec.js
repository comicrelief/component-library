...
test.describe('donate component', () => {
  ...
  test('Donate-example-2 - high value cart', async ({ page }) => {
    ...
    // moneybuy 1
    await page.locator('[data-testid="Donate-example-2"] input[id$="moneyBuy-box1"][aria-label="£7777"]').click();
    await expect(page.locator('[data-testid="Donate-example-2"] input[name="membership_amount"]')).toHaveValue('7777');

    const moneybuyOneButtonText = await page.locator('[data-testid="Donate-example-2"] button[type="submit"]').textContent();
    console.log('buttonText:', moneybuyOneButtonText);

    await expect(page.locator('[data-testid="Donate-example-2"] button[type="submit"]')).toContainText('Donate £7777 now');

    // moneybuy 2
    await page.locator('[data-testid="Donate-example-2"] input[id$="moneyBuy-box2"][aria-label="£8888"]').click();
    await expect(page.locator('[data-testid="Donate-example-2"] input[name="membership_amount"]')).toHaveValue('8888');

    const moneybuyTwoButtonText = await page.locator('[data-testid="Donate-example-2"] button[type="submit"]').textContent();
    console.log('buttonText:', moneybuyTwoButtonText);

    await expect(page.locator('[data-testid="Donate-example-2"] button[type="submit"]')).toContainText('Donate £8888 now');

    // moneybuy 3
    await page.locator('[data-testid="Donate-example-2"] input[id$="moneyBuy-box3"][aria-label="£9999"]').click();
    await expect(page.locator('[data-testid="Donate-example-2"] input[name="membership_amount"]')).toHaveValue('9999');

    const moneybuyThreeButtonText = await page.locator('[data-testid="Donate-example-2"] button[type="submit"]').textContent();
    console.log('buttonText:', moneybuyThreeButtonText);

    await expect(page.locator('[data-testid="Donate-example-2"] button[type="submit"]')).toContainText('Donate £9999 now');

    // amount field validation
    await page.locator('[data-testid="Donate-example-2"] input[name="membership_amount"]').fill('');

    // enter amount 0 should show error message
    await page.locator('[data-testid="Donate-example-2"] input[name="membership_amount"]').type('0');
    await expect(page.locator('[data-testid="Donate-example-2"] p:nth-child(4)')).toContainText('Please enter an amount between £1 and £25000 and up to 2 decimal places');

    // enter amount 25001 should show error message
    await page.locator('[data-testid="Donate-example-2"] input[name="membership_amount"]').fill('');
    await page.locator('[data-testid="Donate-example-2"] input[name="membership_amount"]').type('25001');
    await expect(page.locator('[data-testid="Donate-example-2"] p:nth-child(4)')).toContainText('Please enter an amount between £1 and £25000 and up to 2 decimal places');

    // enter own amount in decimals should not show error message
    await page.locator('[data-testid="Donate-example-2"] input[name="membership_amount"]').fill('');
    await page.locator('[data-testid="Donate-example-2"] input[name="membership_amount"]').type('22000');
    await expect(page.locator('[data-testid="Donate-example-2"] button[type="submit"]')).toContainText('Donate £22000 now');

    // clicking the submit button should take to donate.comicrelief.com
    await page.locator('[data-testid="Donate-example-2"] button[type="submit"]').click();
  ...
  test('Donate-example-3 - Single Giving', async ({ page }) => {
    ...
    // moneybuy 1
    await page.locator('[data-testid="Donate-example-3"] input[id$="moneyBuy-box1"][aria-label="£10"]').click();
    await expect(page.locator('[data-testid="Donate-example-3"] input[name="membership_amount"]')).toHaveValue('10');

    const moneybuyOneButtonText = await page.locator('[data-testid="Donate-example-3"] button[type="submit"]').textContent();
    console.log('buttonText:', moneybuyOneButtonText);

    await expect(page.locator('[data-testid="Donate-example-3"] button[type="submit"]')).toContainText('Donate £10 now');

    // moneybuy 2
    await page.locator('[data-testid="Donate-example-3"] input[id$="moneyBuy-box2"][aria-label="£20"]').click();
    await expect(page.locator('[data-testid="Donate-example-3"] input[name="membership_amount"]')).toHaveValue('20');

    const moneybuyTwoButtonText = await page.locator('[data-testid="Donate-example-3"] button[type="submit"]').textContent();
    console.log('buttonText:', moneybuyTwoButtonText);

    await expect(page.locator('[data-testid="Donate-example-3"] button[type="submit"]')).toContainText('Donate £20 now');

    // moneybuy 3
    await page.locator('[data-testid="Donate-example-3"] input[id$="moneyBuy-box3"][aria-label="£30"]').click();
    await expect(page.locator('[data-testid="Donate-example-3"] input[name="membership_amount"]')).toHaveValue('30');

    const moneybuyThreeButtonText = await page.locator('[data-testid="Donate-example-3"] button[type="submit"]').textContent();
    console.log('buttonText:', moneybuyThreeButtonText);

    await expect(page.locator('[data-testid="Donate-example-3"] button[type="submit"]')).toContainText('Donate £30 now');
    ...
    // enter own amount in decimals should not show error message
    await page.locator('[data-testid="Donate-example-3"] input[name="membership_amount"]').fill('');
    await page.locator('[data-testid="Donate-example-3"] input[name="membership_amount"]').type('20.01');
    await expect(page.locator('[data-testid="Donate-example-3"] button[type="submit"]')).toContainText('Donate £20.01 now');
  ...
  test('Donate-example-4 - Single Giving "No Money Buys"', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="Donate-example-4"] button[type="submit"]')).toContainText('Donate £20');

    // amount field validation
    await page.locator('[data-testid="Donate-example-4"] input[name="membership_amount"]').fill('');

    // enter amount 0 should show error message
    await page.locator('[data-testid="Donate-example-4"] input[name="membership_amount"]').type('0');
    await expect(page.locator('[data-testid="Donate-example-4"] p:nth-child(3)')).toContainText('Please enter an amount between £1 and £25000 and up to 2 decimal places');

    // enter amount 25001 should show error message
    await page.locator('[data-testid="Donate-example-4"] input[name="membership_amount"]').fill('');
    await page.locator('[data-testid="Donate-example-4"] input[name="membership_amount"]').type('25001');
    await expect(page.locator('[data-testid="Donate-example-4"] p:nth-child(3)')).toContainText('Please enter an amount between £1 and £25000 and up to 2 decimal places');

    // enter own amount in decimals should not show error message
    await page.locator('[data-testid="Donate-example-4"] input[name="membership_amount"]').fill('');
    await page.locator('[data-testid="Donate-example-4"] input[name="membership_amount"]').type('20.01');
    await expect(page.locator('[data-testid="Donate-example-4"] button[type="submit"]')).toContainText('Donate £20.01');

    // clicking the submit button should take to donate.comicrelief.com
    await page.locator('[data-testid="Donate-example-4"] button[type="submit"]').click();
  ...
  test('Donate-example-5 - Single Giving "No Money Buys" with overridden manual input value', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="Donate-example-5"] button[type="submit"]')).toContainText('Donate £567.89');
    ...
    await expect(page.locator('[data-testid="Donate-example-5"] p:nth-child(3)')).toContainText('Please enter an amount between £1 and £25000 and up to 2 decimal places');
    ...
    await expect(page.locator('[data-testid="Donate-example-5"] button[type="submit"]')).toContainText('Donate £20.01');
