...
test.describe('marketing preferences component', () => {
  test('marketing preferences', async ({ page }) => {
    ...
    await expect(page.locator('div#marketing-preferences--default div.field-email > div > div > label[for="mp_email"] > span > span')).toContainText('Please enter your email address');

    // postal address fields empty error messages
    // address line 1 error message
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_address1"] > span > span')).toContainText('Please enter the first line of your address');
    // town error message
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_town"] > span > span')).toContainText('Please enter your town');
    // postcode error message
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_postcode"] > span > span')).toContainText('Please enter your postcode');
    // country error message
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_country"] > span > span')).toContainText('Please enter your country');
    // text empty error message
    await expect(page.locator('div#marketing-preferences--default div.field-sms > div > div > label[for="mp_mobile"] > span > span')).toContainText('Please enter your mobile number');
    // phone error message
    await expect(page.locator('div#marketing-preferences--default div.field-phone > div > div > label > span > span')).toContainText('Please enter your phone number');
    ...
    await page.locator('div#marketing-preferences--default input#mp_address1').click();
    await expect(page.locator('div#marketing-preferences--default div.field-email > div > div > label[for="mp_email"] > span > span')).toContainText('Please enter a valid email address');
    ...
    await page.locator('div#marketing-preferences--default input#mp_address1').type('Comic @% Relief');
    await page.locator('div#marketing-preferences--default input#mp_address2').click();
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_address1"] > span > span')).toContainText('This field only accepts alphanumeric characters and , . ( ) / & \' - and must start with an alphanumeric character');
    ...
    await page.locator('div#marketing-preferences--default input#mp_address2').click();
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_town"] > span > span')).toContainText('This field only accepts alphanumeric characters and , . ( ) / & \' - and must start with an alphanumeric character');
    ...
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_town"] > span > span')).toBeHidden('');
    ...
    await page.locator('div#marketing-preferences--default input#mp_address2').click();
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_postcode"] > span > span')).toContainText('Please enter a valid postcode');
    ...
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_postcode"] > span > span')).toBeHidden('');
    ...
    await page.locator('div#marketing-preferences--default input#mp_address2').click();
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_country"] > span > span')).toContainText('This field only accepts alphanumeric characters and , . ( ) / & \' - and must start with an alphanumeric character');
    ...
    await expect(page.locator('div#marketing-preferences--default div.field-post > div > div > label[for="mp_country"] > span > span')).toBeHidden('');
    ...
    await page.locator('div#marketing-preferences--default input#mp_address2').click();
    await expect(page.locator('div#marketing-preferences--default div.field-sms > div > div > label[for="mp_mobile"] > span > span')).toContainText('Please enter a valid UK mobile number');
    ...
    await expect(page.locator('div#marketing-preferences--default div.field-sms > div > div > label[for="mp_mobile"] > span > span')).toBeHidden('');
    ...
    await page.locator('div#marketing-preferences--default input#mp_address2').click();
    await expect(page.locator('div#marketing-preferences--default div.field-phone > div > div > label > span > span')).toContainText('Please enter a valid UK phone number');
    ...
    await expect(page.locator('div#marketing-preferences--default div.field-phone > div > div > label > span > span')).toBeHidden('');
