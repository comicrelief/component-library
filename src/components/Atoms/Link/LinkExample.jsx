...
export default function LinkExample() {
  return (
    <>
      ...
      <ExampleWrapper>
        <Link color="red" href="#anchor" target="blank" type="button" icon={<Chevron direction="left" colour="white" mobileColour="blue" />}>
          Chevron Left (blue mobile-tablet icon, white desktop icon)
        </Link>
      </ExampleWrapper>

      <ExampleWrapper>
        <Link color="red" href="#anchor" target="blank" type="button" icon={<Chevron direction="right" colour="white" mobileColour="blue" />}>
