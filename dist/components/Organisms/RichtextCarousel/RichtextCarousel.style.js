...
}, props => props.tabletHeight, _ref3 => {
  let {
    theme
  } = _ref3;
...
const CarouselWrapper = exports.CarouselWrapper = _styledComponents.default.div.withConfig({
  ...
  return theme.allBreakpoints('M');
}, props => props.tabletHeight, animationSpeed, animationSpeed, animationSpeed, animationSpeed, _ref9 => {
  let {
    theme
  } = _ref9;
  return theme.allBreakpoints('L');
